...
class Seo
{
    ...
    public static function main(){
            ...
            $description = "Интернет-магазин лучших детских товаров в Казахстане - EcoKids. Быстрая доставка в Алматы, Нур-Султан и другие города. Широкий ассортимент товаров по доступным ценам.";
